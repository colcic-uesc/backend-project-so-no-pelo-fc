    ...
    private static readonly List<Professor> _professors = new List<Professor>
        {
            new Professor
            {
                ...
                Bio = "Professor de matemática aplicada com foco em estatísticas."
             },
            new Professor
            {
                Id = 2,
                Name = "Maria Fernandes",
                Email = "maria.fernandes@universidade.edu",
                Department = "Física",
                Bio = "Especialista em física quântica e partículas."
             },
            new Professor
            {
                 Id = 3,
                Name = "João Barreto",
                Email = "joao.barreto@universidade.edu",
                Department = "Ciências da Computação",
                Bio = "Interesses incluem inteligência artificial e aprendizado de máquina."
             }
        };
